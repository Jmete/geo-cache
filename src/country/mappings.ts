/**
 * Country Mappings for Offline ISO2 Resolution (F015)
 *
 * Static lookup tables for converting country text to ISO 3166-1 alpha-2 codes.
 * Supports ISO2, ISO3, English names, and common abbreviations.
 */
...
/**
 * All ISO 3166-1 countries with ISO2, ISO3, and English name.
 * Aliases included for countries with common alternative names.
 */
const COUNTRIES: CountryEntry[] = [
  ...
  { iso2: 'BS', iso3: 'BHS', name: 'Bahamas', aliases: ['the bahamas'] },
  { iso2: 'BH', iso3: 'BHR', name: 'Bahrain', aliases: ['kingdom of bahrain'] },
  ...
  { iso2: 'BO', iso3: 'BOL', name: 'Bolivia', aliases: ['plurinational state of bolivia'] },
  ...
  { iso2: 'BN', iso3: 'BRN', name: 'Brunei', aliases: ['brunei darussalam'] },
  { iso2: 'BG', iso3: 'BGR', name: 'Bulgaria' },
  { iso2: 'BF', iso3: 'BFA', name: 'Burkina Faso' },
  { iso2: 'BI', iso3: 'BDI', name: 'Burundi' },
  { iso2: 'CV', iso3: 'CPV', name: 'Cabo Verde', aliases: ['cape verde'] },
  ...
  { iso2: 'CN', iso3: 'CHN', name: 'China', aliases: ['peoples republic of china'] },
  ...
  { iso2: 'CG', iso3: 'COG', name: 'Congo', aliases: ['republic of the congo', 'congo-brazzaville'] },
  { iso2: 'CD', iso3: 'COD', name: 'Democratic Republic of the Congo', aliases: ['drc', 'congo-kinshasa'] },
  { iso2: 'CK', iso3: 'COK', name: 'Cook Islands' },
  { iso2: 'CR', iso3: 'CRI', name: 'Costa Rica' },
  { iso2: 'CI', iso3: 'CIV', name: 'Cote d\'Ivoire', aliases: ['ivory coast', 'cote divoire'] },
  { iso2: 'HR', iso3: 'HRV', name: 'Croatia' },
  { iso2: 'CU', iso3: 'CUB', name: 'Cuba' },
  { iso2: 'CW', iso3: 'CUW', name: 'Curacao' },
  { iso2: 'CY', iso3: 'CYP', name: 'Cyprus' },
  { iso2: 'CZ', iso3: 'CZE', name: 'Czechia', aliases: ['czech republic'] },
  ...
  { iso2: 'EG', iso3: 'EGY', name: 'Egypt', aliases: ['arab republic of egypt'] },
  ...
  { iso2: 'SZ', iso3: 'SWZ', name: 'Eswatini', aliases: ['swaziland'] },
  ...
  { iso2: 'GM', iso3: 'GMB', name: 'Gambia', aliases: ['the gambia'] },
  ...
  { iso2: 'VA', iso3: 'VAT', name: 'Holy See', aliases: ['vatican', 'vatican city'] },
  ...
  { iso2: 'IR', iso3: 'IRN', name: 'Iran', aliases: ['islamic republic of iran'] },
  ...
  { iso2: 'JO', iso3: 'JOR', name: 'Jordan', aliases: ['hashemite kingdom of jordan'] },
  { iso2: 'KZ', iso3: 'KAZ', name: 'Kazakhstan' },
  { iso2: 'KE', iso3: 'KEN', name: 'Kenya' },
  { iso2: 'KI', iso3: 'KIR', name: 'Kiribati' },
  { iso2: 'KP', iso3: 'PRK', name: 'North Korea', aliases: ['democratic peoples republic of korea', 'dprk'] },
  { iso2: 'KR', iso3: 'KOR', name: 'South Korea', aliases: ['republic of korea', 'korea'] },
  { iso2: 'KW', iso3: 'KWT', name: 'Kuwait', aliases: ['state of kuwait'] },
  { iso2: 'KG', iso3: 'KGZ', name: 'Kyrgyzstan' },
  { iso2: 'LA', iso3: 'LAO', name: 'Laos', aliases: ['lao peoples democratic republic'] },
  ...
  { iso2: 'MO', iso3: 'MAC', name: 'Macao', aliases: ['macau'] },
  ...
  { iso2: 'FM', iso3: 'FSM', name: 'Micronesia', aliases: ['federated states of micronesia'] },
  { iso2: 'MD', iso3: 'MDA', name: 'Moldova', aliases: ['republic of moldova'] },
  ...
  { iso2: 'MM', iso3: 'MMR', name: 'Myanmar', aliases: ['burma'] },
  { iso2: 'NA', iso3: 'NAM', name: 'Namibia' },
  { iso2: 'NR', iso3: 'NRU', name: 'Nauru' },
  { iso2: 'NP', iso3: 'NPL', name: 'Nepal' },
  { iso2: 'NL', iso3: 'NLD', name: 'Netherlands', aliases: ['the netherlands', 'holland'] },
  ...
  { iso2: 'MK', iso3: 'MKD', name: 'North Macedonia', aliases: ['macedonia'] },
  { iso2: 'MP', iso3: 'MNP', name: 'Northern Mariana Islands' },
  { iso2: 'NO', iso3: 'NOR', name: 'Norway' },
  { iso2: 'OM', iso3: 'OMN', name: 'Oman', aliases: ['sultanate of oman'] },
  { iso2: 'PK', iso3: 'PAK', name: 'Pakistan' },
  { iso2: 'PW', iso3: 'PLW', name: 'Palau' },
  { iso2: 'PS', iso3: 'PSE', name: 'Palestine', aliases: ['state of palestine'] },
  ...
  { iso2: 'QA', iso3: 'QAT', name: 'Qatar', aliases: ['state of qatar'] },
  { iso2: 'RE', iso3: 'REU', name: 'Reunion' },
  { iso2: 'RO', iso3: 'ROU', name: 'Romania' },
  { iso2: 'RU', iso3: 'RUS', name: 'Russia', aliases: ['russian federation'] },
  { iso2: 'RW', iso3: 'RWA', name: 'Rwanda' },
  { iso2: 'BL', iso3: 'BLM', name: 'Saint Barthelemy' },
  { iso2: 'SH', iso3: 'SHN', name: 'Saint Helena' },
  { iso2: 'KN', iso3: 'KNA', name: 'Saint Kitts and Nevis' },
  { iso2: 'LC', iso3: 'LCA', name: 'Saint Lucia' },
  { iso2: 'MF', iso3: 'MAF', name: 'Saint Martin' },
  ...
  { iso2: 'SA', iso3: 'SAU', name: 'Saudi Arabia', aliases: ['kingdom of saudi arabia'] },
  ...
  { iso2: 'SY', iso3: 'SYR', name: 'Syria', aliases: ['syrian arab republic'] },
  { iso2: 'TW', iso3: 'TWN', name: 'Taiwan' },
  { iso2: 'TJ', iso3: 'TJK', name: 'Tajikistan' },
  { iso2: 'TZ', iso3: 'TZA', name: 'Tanzania', aliases: ['united republic of tanzania'] },
  { iso2: 'TH', iso3: 'THA', name: 'Thailand' },
  { iso2: 'TL', iso3: 'TLS', name: 'Timor-Leste', aliases: ['east timor'] },
  ...
  { iso2: 'TR', iso3: 'TUR', name: 'Turkey', aliases: ['turkiye'] },
  ...
  { iso2: 'AE', iso3: 'ARE', name: 'United Arab Emirates', aliases: ['emirates'] },
  { iso2: 'GB', iso3: 'GBR', name: 'United Kingdom', aliases: ['great britain', 'britain', 'england', 'scotland', 'wales'] },
  { iso2: 'US', iso3: 'USA', name: 'United States', aliases: ['united states of america', 'america'] },
  { iso2: 'UY', iso3: 'URY', name: 'Uruguay' },
  { iso2: 'UZ', iso3: 'UZB', name: 'Uzbekistan' },
  { iso2: 'VU', iso3: 'VUT', name: 'Vanuatu' },
  { iso2: 'VE', iso3: 'VEN', name: 'Venezuela', aliases: ['bolivarian republic of venezuela'] },
  { iso2: 'VN', iso3: 'VNM', name: 'Vietnam', aliases: ['viet nam'] },
  { iso2: 'VG', iso3: 'VGB', name: 'British Virgin Islands' },
  { iso2: 'VI', iso3: 'VIR', name: 'U.S. Virgin Islands', aliases: ['us virgin islands'] },
...
/**
 * Common abbreviations that are not ISO codes.
 * Maps to ISO2 codes.
 */
const ABBREVIATIONS: Record<string, string> = {
  ...
  USA: 'US', // Also valid ISO3, but commonly used as abbrev
  RSA: 'ZA', // Republic of South Africa
  PRC: 'CN', // People's Republic of China
  ROK: 'KR', // Republic of Korea
  DPRK: 'KP', // Democratic People's Republic of Korea
...
/** Set of valid ISO2 codes for O(1) validation */
export const ISO2_SET: ReadonlySet<string> = new Set(
  COUNTRIES.map((c) => c.iso2)
);

/** ISO3 to ISO2 mapping */
export const ISO3_TO_ISO2: ReadonlyMap<string, string> = new Map(
  COUNTRIES.map((c) => [c.iso3, c.iso2])
);

/** Abbreviations to ISO2 mapping (uppercase keys) */
export const ABBREV_TO_ISO2: ReadonlyMap<string, string> = new Map(
...
/** Country names to ISO2 mapping (normalized lowercase keys) */
export const NAME_TO_ISO2: ReadonlyMap<string, string> = new Map(
  COUNTRIES.flatMap((c) => {
    const entries: [string, string][] = [
      [normalizeNameForLookup(c.name), c.iso2],
    ];
    if (c.aliases) {
      for (const alias of c.aliases) {
        entries.push([normalizeNameForLookup(alias), c.iso2]);
      }
    }
    return entries;
  })
...
/** ISO2 to English country name (for display purposes) */
export const ISO2_TO_NAME: ReadonlyMap<string, string> = new Map(
  COUNTRIES.map((c) => [c.iso2, c.name])
);

/** Re-export normalizer for use in index.ts */
export { normalizeNameForLookup };
